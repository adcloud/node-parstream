...
Client.prototype.connect = function connect(cb) {
  ...
  self.socket.on('connect', function() {
    ...
    self.socket.on('data', function(chunk) {
      ...
      if (self.current !== null && typeof self.current.callback === 'function') {
...
Client.prototype.queue = function request(payload, cb) {
  ...
  if (self.current !== null) return self.requestQueue.push([].slice.call(arguments))
